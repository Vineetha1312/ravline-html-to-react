                    ...
                    <div className="row clearfix">
                        ...
                        <div className="col-lg-4 col-md-6 col-sm-12 service-block">
                            <div className="service-block-one">
                                ...
                                <p>Estate Planning (Will & Trust) protection plans assist users in creating legally binding documents that manage the distribution of assets after death. These plans often include tools to draft and update wills, set up trusts, and ensure estate planning aligns with the user’s wishes.</p>
